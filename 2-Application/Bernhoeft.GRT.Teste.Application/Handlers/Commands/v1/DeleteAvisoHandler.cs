...
{
    public class DeleteAvisoHandler : IRequestHandler<DeleteAvisoCommand, IOperationResult<bool>>
    {
        ...
        public async Task<IOperationResult<bool>> Handle(DeleteAvisoCommand request, CancellationToken cancellationToken)
        {

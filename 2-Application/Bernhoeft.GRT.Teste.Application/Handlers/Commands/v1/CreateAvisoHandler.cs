...
{
    public class CreateAvisoHandler : IRequestHandler<CreateAvisoCommand, IOperationResult<int>>
    {
        ...
        public async Task<IOperationResult<int>> Handle(CreateAvisoCommand request, CancellationToken cancellationToken)
        {
            ...
            return OperationResult<int>.ReturnOk(aviso.Id);
        }
    }
}